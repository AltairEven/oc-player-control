...
@implementation ALSVPCCountDown
...
- (void)startCountDownWithCurrentTimeLeft:(void (^)(NSTimeInterval))currentBlock completion:(void (^)(void))completion {
    self.currentBlock = currentBlock;
...
- (void)startCountDownTimer {
    ...
    __weak ALSVPCCountDown *weakSelf = self;
